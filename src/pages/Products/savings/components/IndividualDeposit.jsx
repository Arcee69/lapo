...
const IndividualDeposit = () => {
    ...
    const getFaqCategories = async () => {
        ...
        if (faqCategories?.length > 0) {
            const loanCategory = faqCategories?.find(cat => cat.name === 'Individual Deposit Account');
            if (loanCategory) {
    ...
    <div className='w-full'>
        ...
        <SavingsDetails
            ...
            details={`
                ...
                The savings amount are decided by clients and withdrawals made more than thrice in a month is 
                tantamount to loss of interest.
            `}
            listContent={[
