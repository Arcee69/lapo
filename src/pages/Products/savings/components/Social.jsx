...
const Social = () => {
    ...
    const getFaqCategories = async () => {
        ...
        if (faqCategories?.length > 0) {
            const loanCategory = faqCategories?.find(cat => cat.name === 'Social Impact Deposit');
            if (loanCategory) {
  ...
  return (
    <div className='w-full'>
        ...
        <SavingsDetails
            img="https://res.cloudinary.com/dairsbzlv/image/upload/v1740880232/plant_tupnt3.png" 
            details={`
                SID is a special deposit/investment platform which provides high net worth individuals/corporate 
                entities the opportunity to make deposit with LAPO that can be used for social impact on the 
                bottom of the pyramid of the society. Requirements for subscribing to this product are classified 
