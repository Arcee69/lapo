  ...
  return (
    <div className='w-full'>
        ...
        <SavingsDetails
            ...
            details={`
                The Xpress Savings Account provides a convenient and flexible savings option for clients 
                who wish to save voluntarily. This account allows for easy access to funds, making it ideal 
