    ...
    <div className='w-full'>
        ...
        >
            <div className='flex flex-col pt-[133px]'>
                <div className='flex flex-col items-center gap-4 w-[1088px] mx-auto'>
                    <p className='font-inter font-semibold text-base leading-[64px] text-[#EAECF0]'>
        ...
        <section
            className='bg-[#fff] flex flex-col py-[96px] px-[80px] items-center gap-[64px] justify-center'
            data-aos="fade-up" 
            data-aos-duration="1000" 
            data-aos-easing="linear"
        >
            <div className='flex flex-col items-center justify-center gap-3'>
                ...
                <p className='font-hanken text-[#101828] font-medium text-[48px] leading-[44px]'>Why Choose the LAPO Debit Card?</p>
            </div>
            <div className='flex items-start gap-[96px]'>
                <div className='w-[391.82px] h-[428px] flex flex-col gap-[48px]'>
                ...
                <img src={CardMain} alt="CardMain" className='w-[374px] h-2/3' />
        ...
        <section
            className='px-[80px] py-[96px] flex flex-col items-center gap-[21px]'
            data-aos="fade-up" 
            data-aos-duration="1000" 
            data-aos-easing="linear"
        >
            <div className='flex flex-col items-center w-[768px] justify-center gap-3'>
                <div className='bg-[#E8FFF4] w-[75px] flex items-center justify-center flex-col h-[32px] rounded-[6px]'>
                    <p className='font-hanken text-sm font-medium leading-[15px] text-[#00954B]'>Benefits</p>
                </div>
                <p className='font-hanken text-[#101828] text-center font-medium capitalize text-[54px] leading-[70px]'>
                    Experience easy banking with our USSD platform
                </p>
            </div>

            <img src={Code} className="w-[990px] mx-auto" alt='Code' />
