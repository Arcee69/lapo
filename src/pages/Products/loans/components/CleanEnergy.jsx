...
const CleanEnergy = () => {
    ...
    if (faqCategories?.length > 0) {
        const loanCategory = faqCategories?.find(cat => cat.name === 'Clean Energy Loans');
        if (loanCategory) {
  ...
  return (
    <div className='w-full'>
        <SubLoansHeader 
            title="Clean Energy Loan"
            subtitle={`This loan product is designed to provide Individual and Group with  clean energy products. The clean energy products sold to LAPO clients ranging from gas cylinder, Bajaj CNG Keke, Clean cookstove, solar fans, solar lamps, solar radio, solar fridge, solar freezer, Complete Solar Home Solution (includes sales and installation of inverter, batteries and panels) to foster the eco-friendly initiative of LAPO MfB Limited.`}
            link="/loans/clean-energy"
        />
        <section
        ...
        >
            <div className='bg-[#FCF7F9] rounded-lg grid grid-cols-2 lg:grid-cols-4'>
                <div className='flex w-[10.688rem] lg:w-[19.7rem] flex-col items-center py-[32px] justify-center gap-4 border border-l-0 border-r-[1px] border-y-0 border-[#EEEEEE]'>
                    ...
                    <p className='font-hanken font-semibold text-base lg:text-[20px] leading-5 lg:leading-[38px] text-[#360E22]'>₦5,000 - ₦7,000,000</p>
                </div>
                <div className='flex w-[10.688rem] lg:w-[19.7rem] flex-col items-center py-[32px] justify-center gap-4 border border-l-0 border-r-[1px] border-y-0 border-[#EEEEEE]'>
                    ...
                    <p className='font-hanken font-semibold lg:text-[20px] leading-5 lg:leading-[38px] text-[#360E22]'>1 - 12 Months</p>
                </div>
                <div className='flex w-[10.688rem] lg:w-[19.7rem] flex-col items-center py-[32px] justify-center gap-4 border border-l-0 border-r-[1px] border-y-0 border-[#EEEEEE]'>
                    ...
                    <p className='font-hanken font-semibold p-2 text-center lg:text-[20px] leading-5 lg:leading-[25px] text-[#360E22]'>Individual and Group/Association</p>
                </div>
                <div className='flex w-[10.688rem] lg:w-[19.7rem] flex-col items-center py-[32px] justify-center gap-4'>
                    ...
                    <p className='text-base font-inter leading-[22px] text-[#445D65]'>Repayment frequency</p>
                    <p className='font-hanken font-semibold text-center lg:text-[20px] leading-5 lg:leading-[25px] text-[#360E22]'>Weekly & Monthly</p>
                </div>
            </div>
        </section>
        ...
        <LoanDetails
            ...
            listContent={[
                "No Collateral",
                "Access to green (clean energy) products",
                "Flexible Repayment Structure",
                "Low Interest Rate",
            ]}
            details={`This loan product is designed to provide Individual and Group with  clean energy products. 
                The clean energy products sold to LAPO clients ranging from gas cylinder, Bajaj CNG Keke, 
                Clean cookstove, solar fans, solar lamps, solar radio, solar fridge, solar freezer,
                Complete Solar Home Solution (includes sales and installation of inverter, batteries and panels) to 
                foster the eco-friendly initiative of LAPO MfB Limited.`
            }
            featuresContent={[
                `One Off Payment: Clients with sufficient funds to make one-off payments 
                without accessing the loan are allowed.`,
            ]}
            documentContent={[
