...
const Payroll = () => {
    ...
    if (faqCategories?.length > 0) {
        const loanCategory = faqCategories?.find(cat => cat.name === 'Payroll Lending');
        if (loanCategory) {
    ...
    <div className='w-full'>
        ...
        >
            <div className='bg-[#FCF7F9] rounded-lg grid grid-cols-2 lg:grid-cols-4'>
                <div className='flex w-[10.688rem] lg:w-[19.7rem] flex-col items-center py-[32px] justify-center gap-4 border border-l-0 border-r-[1px] border-y-0 border-[#EEEEEE]'>
                    ...
                    <p className='font-hanken font-semibold text-base lg:text-[20px] leading-5 lg:leading-[38px] text-[#360E22]'>₦20K - ₦3M</p>
                </div>
                <div className='flex w-[10.688rem] lg:w-[19.7rem] flex-col items-center py-[32px] justify-center gap-4 border border-l-0 border-r-[1px] border-y-0 border-[#EEEEEE]'>
                    ...
                    <p className='font-hanken font-semibold lg:text-[20px] leading-5 lg:leading-[38px] text-[#360E22]'>12 Months</p>
                </div>
                <div className='flex w-[10.688rem] lg:w-[19.7rem] flex-col items-center py-[32px] justify-center gap-4 border border-l-0 border-r-[1px] border-y-0 border-[#EEEEEE]'>
                    ...
                    <p className='font-hanken font-semibold text-center lg:text-[20px] leading-5 lg:leading-[25px] text-[#360E22]'>Individual</p>
                </div>
        ...
        <LoanDetails
            ...
            details={` 
                ...
                Civil Servants at the State and Federal levels. This is deduction-based, as repayments due to 
                LAPO MfB are deducted at source before salary payments are made to obligors.
                No personal Guarantor is required for this loan, however, with the acquisition of 
