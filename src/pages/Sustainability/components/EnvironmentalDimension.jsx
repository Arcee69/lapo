  ...
  return (
    <div className='w-full'>
      <div className='mt-[4rem] flex flex-col gap-[4rem]'>
        <section 
          className='flex flex-col gap-[23px] px-[7.5rem]'
          data-aos="fade-up" 
          data-aos-duration="1000" 
          data-aos-easing="linear"
        >
          <p className='font-hanken font-medium text-[48px] leading-[51px]'>Our Commitment to Sustainability</p>
          ...
          <div className='flex items-center gap-[32px]'>
            <div className='w-[23.875rem] h-[26.25rem] shadow-md flex flex-col'>
              <img 
                src="https://res.cloudinary.com/dairsbzlv/image/upload/v1741083415/harvesters_cgyhhj.png" 
                alt='Harvesters' 
                className='w-[23.9rem] h-[12.5rem] rounded-t-lg' 
              />
        ...
        <section 
          className='flex flex-col gap-[31px] px-[7.5rem]'
          data-aos="fade-up" 
          data-aos-duration="1000" 
          data-aos-easing="linear"
        >
          <div className='flex flex-col gap-[23px]'>
            <p className='font-hanken text-[48px] leading-[51px]'>ESG Implementation</p>
            <p className='font-inter text-base text-[#333333] leading-[25px]'>
          ...
          <div className='bg-[#FAFBFB] w-full flex gap-[32px]'>
            <div className='flex flex-col items-center justify-center gap-2 w-[22.333rem] p-6'>
              <p className='text-[#4380BE] font-semibold font-inter text-[40px] leading-[64px]'>2012</p>
              <p className='font-inter text-[#666666] text-base'>ESG Initiative Commenced</p>
            </div>
            <div className='flex flex-col items-center justify-center gap-2 w-[22.333rem] p-6'>
              <p className='text-[#4380BE] font-semibold font-inter text-[40px] leading-[64px]'>40,816</p>
              <p className='font-inter text-[#666666] text-base'>Loan Appraisals Screened</p>
            </div>
            <div className='flex flex-col items-center justify-center gap-2 w-[22.333rem] p-6'>
              <p className='text-[#4380BE] font-semibold font-inter text-[40px] leading-[64px]'>3</p>
              <p className='font-inter text-[#666666] text-base'>Core ESG Elements</p>
            </div>
          </div>

          <div className='flex flex-col gap-4'>
            <p className='font-inter font-semibold text-[#4380BE] text-[24px]'>Areas Assessed Under ESMS:</p>
        ...
        <section
          ...
          data-aos-duration="1000" 
          data-aos-easing="linear"
          className='bg-[#FAFBFB] w-full h-[25.5rem] px-[7.5rem] py-[3rem] flex flex-col gap-[31px]'
        >
          <div className='flex flex-col gap-[23px]'>
            <p className='font-hanken text-[48px] text-[#1E1E1E]'>Affordable Housing Loan Scheme (AHLS)</p>
            <p className='font-inter text-base text-[#333333] leading-[25px]'>
          ...
          <div className='flex items-center gap-[32px]'>
            <div className='bg-[#FFFFFF] rounded-[22px] w-[34.5rem] h-[9rem] p-6 flex flex-col items-center justify-center gap-2'>
              <p className='font-inter text-[#4380BE] font-semibold text-[40px] leading-[64px]'>2,877</p>
              <p className='font-inter text-base text-[#666666]'>Clients Served</p>
            </div>
            <div className='bg-[#FFFFFF] rounded-[22px] w-[34.5rem] h-[9rem] p-6 flex flex-col items-center justify-center gap-2'>
              <p className='font-inter text-[#4380BE] font-semibold text-[40px] leading-[64px]'>₦4.08B</p>
        ...
        <section
          ...
          data-aos-duration="1000" 
          data-aos-easing="linear"
          className='px-[7.5rem] flex flex-col gap-[31.9px]'
        >
          <div className='flex flex-col gap-[23px]'>
            <p className='text-[#1E1E1E] font-hanken text-[48px] leading-[51px]'>Clean Energy Programs</p>
            <p className='font-inter text-[#333333] text-[16px]'>
          ...
          <div className='flex gap-[32px]'>
            <div className='flex flex-col w-[34.5rem] shadow-md'>
              <img 
                src="https://res.cloudinary.com/dairsbzlv/image/upload/v1741087679/gas_qbmqaq.png" 
                alt='Gas' 
                className='rounded-t-lg  h-[277.13px]' 
              />
        ...
        <section
          ...
          data-aos-duration="1000" 
          data-aos-easing="linear"
          className='px-[7.5rem] bg-[#FAFBFB] flex flex-col gap-[23px] h-[53rem] pt-[48px]'
        >
          <p className='font-hanken text-[#1E1E1E] text-[48px] leading-[51px]'>Workplace Safety and Health Initiatives</p>
          <div className='gap-[22px] flex flex-col'>
            <div className='flex flex-col gap-[15px]'>
              <p className='font-inter text-[#4380BE] text-[24px] font-bold'>Occupational Health & Safety (OHS)</p>
            ...
            <div className='flex flex-col gap-[15px]'>
              <p className='font-inter text-[#4380BE] text-[24px] font-bold'>Health Awareness Programs</p>
              <p className='text-base font-inter text-[#333333] leading-[25px]'>
          ...
          <div className='flex flex-col gap-4'>
            <div className='flex items-center gap-4'>
              <div className='bg-[#4380BE] w-[17rem] h-[126.39px] rounded-lg flex flex-col items-center justify-center'>
                <p className='font-inter font-bold text-[24px] text-[#FFFFFF]'>HIV</p>
              </div>
              <div className='bg-[#4380BE] w-[17rem] h-[126.39px] rounded-lg flex flex-col items-center justify-center'>
                <p className='font-inter font-bold text-[24px] text-[#FFFFFF]'>Malaria</p>
              </div>
              <div className='bg-[#4380BE] w-[17rem] h-[126.39px] rounded-lg flex flex-col items-center justify-center'>
                <p className='font-inter font-bold text-[24px] text-[#FFFFFF]'>Blood Pressure</p>
              </div>
              <div className='bg-[#4380BE] w-[17rem] h-[126.39px] rounded-lg flex flex-col items-center justify-center'>
                <p className='font-inter font-bold text-[24px] text-[#FFFFFF]'>Blood Sugar</p>
              </div>
            </div>
            <div className='flex items-center gap-4'>
          ...
          <p className='font-inter text-[#00984C] font-semibold font-italic text-[24px]'>
