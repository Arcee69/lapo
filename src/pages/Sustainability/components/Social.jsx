...
const Social = () => {
  ...
  return (
    <div className='w-full'>
        <section
            className='flex flex-col items-start px-[63px] pt-[103px] pb-[27px] gap-[34px]'
            data-aos="fade-up" 
            data-aos-duration="1000" 
            data-aos-easing="linear"
        >
            <p className='font-hanken text-[54px] leading-[29px] text-[#2C3E50]'>LAPO MfB’s Social Dimension</p>
        ...
        <section
            className='flex flex-col items-center px-[76px] py-[53px] gap-[50px]'
            data-aos="fade-up" 
            data-aos-duration="1000" 
            data-aos-easing="linear"
        >
            <div className='flex flex-col items-center gap-2'>
                ...
                <p className='font-hanken text-[54px] w-[846px] leading-[54px] text-center text-[#000504]'>
            ...
            <div className="flex flex-col gap-10">
                <div className='flex items-start gap-10'>
                    <div className='bg-[#4380BE17] px-6 py-[22px] h-[355px] flex flex-col gap-1 rounded-xl w-6/12'>
                        <p className='font-hanken font-medium text-[32px] leading-[48px] text-[#101828]'>LAPO Scholarship Scheme.</p>
                ...
                <div className='flex items-start gap-10'>
                    ...
                    <div className='bg-[#4380BE17] px-6 py-[22px] h-[355px] flex flex-col gap-1 rounded-xl w-6/12'>
                        <p className='font-hanken font-medium text-[32px] leading-[48px] text-[#101828]'>Skills Acquisition</p>
                        <p className='font-inter font-[300] text-[#101828] text-base leading-6'>
                ...
                <div className='flex items-start gap-10'>
                    <div className='bg-[#4380BE17] px-6 py-[22px] h-[355px] flex flex-col gap-1 rounded-xl w-6/12'>
                        <p className='font-hanken font-medium text-[32px] leading-[48px] text-[#101828]'>Health Intervention</p>
                        <p className='font-inter font-[300] text-[#101828] text-base leading-6'>
            ...
            <div className='flex flex-col items-center gap-2'>
                <div className='bg-[#4380BE] rounded-[15px] flex flex-col py-[42px] px-6'>
                    <p className='font-hanken text-[#FFFFFF] font-medium text-[32px] leading-[48px]'>Integration Programme</p>
                ...
                <div className='flex items-center gap-[15px] '>
                    <div className='bg-[#fff] drop-shadow-md h-[232px] w-6/12 rounded-[15px] py-[32px] px-6 flex flex-col gap-1'>
                        <p className="text-[#4380BE] font-medium text-[32px] leading-[48px] font-hanken">Health Awareness</p>
                    ...
                    <div className='bg-[#fff] drop-shadow-md h-[232px] w-6/12 rounded-[15px] py-[32px] px-6 flex flex-col gap-1'>
                        <p className="text-[#4380BE] font-medium text-[32px] leading-[48px] font-hanken">Insurance</p>
                        <p className='text-[#101828] text-base font-inter leading-6 font-[300]'>
