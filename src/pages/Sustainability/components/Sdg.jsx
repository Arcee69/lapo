...
const Sdg = () => {
  ...
  return (
    <div className='w-full'>
      ...
      >
        <div className="bg-[#F8F9FA] rounded-[20px] w-full h-[21.188rem] p-5 gap-[18px] flex-col flex">
          <div className="border border-[#4380BE66] p-3 border-x-0 border-t-0">
            <p className="font-hanken text-[54px] text-[#1E1E1E] leading-[59px]">United Nations Sustainable Development Goals (SDGs)</p>
          </div>
        ...
        <img 
          ...
          alt='World Man'
          className='h-[34.125rem] w-full'
        />

        <div className='grid grid-cols-2 gap-6'>
          {
            sdgData.map((item, index) => (
              <div className='h-[15.24rem] shadow flex items-start' key={index}>
                <div 
                  style={{
                    backgroundColor: item.bgc
                  }}
                  className={`flex flex-col rounded-tl-lg rounded-bl-lg items-center justify-center px-5 min-w-[120px] h-[15.24rem]`}
                >
                ...
                <div className='p-6 h-[15.24rem] flex flex-col gap-[7.13px]'>
