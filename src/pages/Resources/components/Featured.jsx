...
const Featured = ({ featuredRef, data, loading }) => {
    ...
    <div className='w-full gap-6 flex flex-col' ref={featuredRef}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            { loading ? 
                ...
                data?.map((item) => (
                    <div key={item.id} className='gap-6 p-6 flex flex-col shadow-md'>
                        <div className='items-start gap-4 flex'>
                            <img src={Target} className='w-[3rem] h-[3rem]' alt='icon' />
                ...
                <p className='text-2xl font-inter text-[#000] text-center font-semibold mt-10'>No Resource Available</p>
            }
