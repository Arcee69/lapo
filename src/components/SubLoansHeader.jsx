...
const SubLoansHeader = ({title, subtitle, link }) => {
  ...
  return (
    ...
    >
        ...
        <div className='flex flex-col items-center pt-[150px] lg:pt-[173px]'>
            <div className='flex flex-col items-center gap-4 lg:w-[688px] mx-auto'>
                <div className='w-[96px] h-[28px] rounded-full gap-1 flex items-center justify-center bg-[#FDF2E9]'>
                    ...
                    <p className='text-xs font-hanken text-[#E78020]'>Loans</p>
                </div>
                <div className='flex flex-col items-center px-5 lg:px-0 gap-6'>
                    <p className='font-hanken text-[30px] leading-[32px] lg:text-[56px] text-center font-medium text-[#FFFFFF] lg:leading-[56px]'>
                        {title}
                    </p>
